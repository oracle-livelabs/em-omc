...
- Install IntelliJ and enable Oracle AI Code Assist plugin 
- Connect to Oracle Kubernetes cluster
...
15. Make sure **Oracle Kubernetes Cluster-VCN**  and  and  **public subnet-Oracle Kubernetes-VCN** are selected. Keep Public IPV4 address **Assign..** default
...
2. Copy the private IP address of the active MySQL HeatWave Instance to your notepad
    ...
    - Go to Navigation Menu
        - Databases
        - MySQL
        - Click the `HEATWAVE Database` Database System link
