...
1. In the **Fleet Summary** page, select **sales-database**.

     ![Fleet Summary](./images/fleet-summary-selection.png " ")

2. Click the **sales database** database. In the **Resources** page you will get to the **Summary** section.
...
2. In the Alarm definitions section, you can create Oracle recommended alarms that are preconfigured for common operational scenarios for your External MySQL DB system.
