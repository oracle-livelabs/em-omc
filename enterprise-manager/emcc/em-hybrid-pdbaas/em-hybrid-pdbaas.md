...
|--------|----------------------------------------------------------------------------|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1    | Overview of SSA User and associated role                                      | 10min                     | Overview of SSA User and SSA Admin User.                                                                                  | Enterprise Manager contains 4 main out-of-the-box roles for the Cloud Self Service Portal, 
EM_CLOUD_ADMINISTRATOR - Users with this role can set up and manage the cloud infrastructure. This role is responsible for deploying the cloud infrastructure
EM_SSA_ADMINISTRATOR - Users with this role can define quotas and constraints for the self service users and grant them access privileges. Users with this role also have provisioning and patching. These privileges are required for initial setup and on going maintenance of the infrastructure.
...
In this lab we are using sysman user inplace of EM_CLOUD_ADMINISTRATOR. A user called 'cyrus' has been precreated and granted EM_SSA_USER role.
You can check the documentation for more details - Defining roles and assigning users.                                                                                                           |
