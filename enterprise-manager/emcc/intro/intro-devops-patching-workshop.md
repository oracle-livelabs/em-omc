...
* Setup Oracle Enterprise Manager DBaaS for Pluggable Databases along with Fleet Maintenance for patching
* Provision and patch a Pluggable Database using Ansible playbooks and EM's DBaaS capabilities
