...
| 3                                                         | Database Configuration drift management                                 | 20 minutes   | Compare the latest or saved target configuration to one or more targets                                                                           | Detect unauthorized changes in any Oracle database environment between databases in a systematic and efficient way to detect any inconsistencies and ensure that configuration changes have been done properly, by comparing before and after|
| 4                                                         |  CIS standard Database security Compliance Standard | 10 minutes                    | Databases target                | Enhance security posture of databases by leveraging industry-standard CIS Benchmark, provides recommended security settings and results gathered from Oracle database settings, account restrictions, audit and logging policies, and more                                                       | Monitor security compliance for host targets from one customized dashboard |
| 5                                                         | Host Security Compliance                                  | 10 minutes   | Host target                                                                                                                       | Monitor security compliance for host targets from one reference compliance and implementing innovative security compliance measures that meet or exceed applicable security regulations and standards. |
