...
3.  Go to Templates library on the left panel, Clicking on Templates will navigate to Comparison Templates Page. **Sort Name Alphabetically**

look for Database Instance Template as shown below.
