...
- **Access Process Monitoring**
   - Select compartment **AIW25_Log_Analytics**
...
![Fusion and OIC Process Monitoring Dashboard](images/logan-ll-fusion-oic-process-monitoring-dashboard.png)

### **Summary - Analytics Scope widget**

**Purpose**: Provides an overview of the Oracle Integration Cloud environment. 
- **Business Use**: Understand the OIC environment and the project scope
- **Key Insights**: 
...
- **Business Use**: Monitor OIC integration volume trends, identify peak processing times, and track integration usage for capacity planning
- **Key Insights**: 
...
![ESS Jobs Schedule Heatmap](images/logan-ll-fusion-oic-process-monitoring-dashboard-ess-jobs-schedule-heatmap.png)

![ESS Jobs Performance](images/logan-ll-fusion-oic-process-monitoring-dashboard-ess-jobs-performance.png)
...
![Transaction Performance](images/logan-ll-fusion-oic-process-monitoring-dashboard-transaction-performance.png)

![ERP Purchase Order Transaction Details](images/logan-ll-fusion-oic-process-monitoring-dashboard-erp-purchase-order-transaction-details.png)

![ERP Purchase Order Transaction Details Event Sequence](images/logan-ll-fusion-oic-process-monitoring-dashboard-erp-purchase-order-transaction-details-event-sequence.png)

![OIC Integration Time Taken Analysis](images/logan-ll-fusion-oic-process-monitoring-dashboard-oic-integration-time-taken-analysis.png)
